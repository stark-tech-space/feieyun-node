...
var USER = process.env.API_USER; //必填，飞鹅云 www.feieyun.cn后台注册的账号名
var UKEY = process.env.API_KEY; //必填，飞鹅云后台注册账号后生成的UKEY

//以下URL参数不需要修改
var HOST = 'http://api.jp.feieyun.com'; //域名
var PORT = '80'; //端口
var PATH = '/Api/Open/'; //接口路径

export function print(sn) {
	//标签说明：
	//单标签:
